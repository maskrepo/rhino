...
object HelperRhino {
    ...
    fun obtenirMaskActionPourUneIdReference(_idReference : String , maskLot: MaskLot ) : MaskAction {
        ...
        if(listeActions.size != 1) throw IllegalStateException("Tentative de mise à jour de l'état d'une action. Or, on ne l'a retrouve pas une et une seule fois dans la liste des actions.")
